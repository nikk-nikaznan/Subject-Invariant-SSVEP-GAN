...
def acgan(datatrain, label, nseed, test_idx):
...
for train_idx, test_idx in loo.split(input_data):
    ...
    gen_data, gen_label = acgan(train_data, train_label, seed_n, test_idx)

    data_filename = "ACGAN_unseen%i.npy"
    label_filename = "ACGAN_unseen%i_labels.npy"
