...
for train_idx, test_idx in loo.split(real_data):
    ...
    # ************************************************************
    # # For augmentation
    # train_input = [real_data[train_idx], fake_data[test_idx]]
    # train_input = np.asarray(train_input)
    # train_label = [real_label[train_idx], fake_label[test_idx]]
    # train_label = np.asarray(train_label) 
    
    # For non-augmentation -- real
    train_input = real_data[train_idx]
    train_label = real_label[train_idx]

    # # For non-augmentation -- fake
    # train_input = fake_data[test_idx]
    # train_label = fake_label[test_idx]
    ...
    test_input = real_data[test_idx]
    test_label = real_label[test_idx]
